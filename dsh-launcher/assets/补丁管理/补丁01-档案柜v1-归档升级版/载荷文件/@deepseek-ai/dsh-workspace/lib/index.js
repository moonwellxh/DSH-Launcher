...
var WorkspaceRegistry = class extends Service {
	...
	*/
	...
	/**
	* Restore (unarchive) one session durably: remove it from the
	* registry-global archive set so it becomes visible again in its original
	* accounting position. An id not currently archived resolves without
	* writing.

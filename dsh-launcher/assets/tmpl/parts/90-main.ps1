...
$miBranch.Add_Click({
    try {
        ...
        $f.Controls.Add($lbl); $f.Controls.Add($cb); $f.Controls.Add($btnOk); $f.Controls.Add($btnCancel)
        [void]$f.ShowDialog()
        $f.Dispose()

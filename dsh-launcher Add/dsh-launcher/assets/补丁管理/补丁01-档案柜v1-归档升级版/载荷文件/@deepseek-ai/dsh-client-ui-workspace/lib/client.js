window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\雍远\deepseek-harness\packages\client\ui-workspace\src\client\rows\Rows.module.css.mjs
		const css$2 = ".XaHNzq_projectRow,.XaHNzq_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.XaHNzq_projectRow:hover,.XaHNzq_sessionRow:hover,.XaHNzq_sessionRow.XaHNzq_selected{background:var(--dsw-alias-interactive-bg-hover)}.XaHNzq_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.XaHNzq_searchResultRow:hover,.XaHNzq_searchResultRow.XaHNzq_selected{background:var(--dsw-alias-interactive-bg-hover)}.XaHNzq_searchResultHeading{align-items:center;min-width:0;display:flex}.XaHNzq_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.XaHNzq_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.XaHNzq_searchResultWorkspace,.XaHNzq_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.XaHNzq_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.XaHNzq_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.XaHNzq_projectRow{box-sizing:border-box;align-items:center;height:34px}.XaHNzq_projectRow .XaHNzq_rowActions{height:20px}.XaHNzq_sessionRow{height:32px;animation:XaHNzq_row-in .15s var(--ds-ease-in-out);gap:0}.XaHNzq_sessionRow .XaHNzq_title{margin:0 6px 0 4px}.XaHNzq_flatSessionRowWithoutStatus .XaHNzq_title{margin-left:0}@keyframes XaHNzq_row-in{0%{opacity:0}}.XaHNzq_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.XaHNzq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.XaHNzq_folderActive{color:var(--dsw-alias-state-business-primary)}.XaHNzq_projectRow .XaHNzq_chevron{display:none}.XaHNzq_projectRow:hover .XaHNzq_chevron{display:inline-flex}.XaHNzq_projectRow:hover .XaHNzq_folder{display:none}.XaHNzq_arrow{transition:transform .15s var(--ds-ease-in-out)}.XaHNzq_arrowOpen{transform:rotate(90deg)}.XaHNzq_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.XaHNzq_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.XaHNzq_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.XaHNzq_sessionRow .XaHNzq_title{flex:1}.XaHNzq_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.XaHNzq_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.XaHNzq_dot{flex:none}.XaHNzq_rowActions{flex:none;align-items:center;gap:12px;display:none}.XaHNzq_projectRow:hover .XaHNzq_rowActions,.XaHNzq_sessionRow:hover .XaHNzq_rowActions,.XaHNzq_projectRow.XaHNzq_menuOpen .XaHNzq_rowActions,.XaHNzq_sessionRow.XaHNzq_menuOpen .XaHNzq_rowActions{display:inline-flex}.XaHNzq_sessionRow:hover .XaHNzq_time,.XaHNzq_sessionRow.XaHNzq_menuOpen .XaHNzq_time{display:none}.XaHNzq_projectRow.XaHNzq_menuOpen,.XaHNzq_sessionRow.XaHNzq_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.XaHNzq_sessionRow.XaHNzq_dropBefore,.XaHNzq_sessionRow.XaHNzq_dropAfter{position:relative}.XaHNzq_sessionRow.XaHNzq_dropBefore:before,.XaHNzq_sessionRow.XaHNzq_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.XaHNzq_sessionRow.XaHNzq_dropBefore:before{top:-7px}.XaHNzq_sessionRow.XaHNzq_dropAfter:after{bottom:-7px}.XaHNzq_hoverContent{flex-direction:column;gap:8px;display:flex}.XaHNzq_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.XaHNzq_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.XaHNzq_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.XaHNzq_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.XaHNzq_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.XaHNzq_iconButton:hover{color:var(--dsw-alias-label-primary)}.XaHNzq_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.XaHNzq_sessionRow,.XaHNzq_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "XaHNzq_arrow",
			"arrowOpen": "XaHNzq_arrowOpen",
			"chevron": "XaHNzq_chevron",
			"dot": "XaHNzq_dot",
			"dropAfter": "XaHNzq_dropAfter",
			"dropBefore": "XaHNzq_dropBefore",
			"flatSessionRowWithoutStatus": "XaHNzq_flatSessionRowWithoutStatus",
			"folder": "XaHNzq_folder",
			"folderActive": "XaHNzq_folderActive",
			"hoverContent": "XaHNzq_hoverContent",
			"hoverPath": "XaHNzq_hoverPath",
			"hoverStatus": "XaHNzq_hoverStatus",
			"hoverTime": "XaHNzq_hoverTime",
			"hoverTitle": "XaHNzq_hoverTitle",
			"iconButton": "XaHNzq_iconButton",
			"menuOpen": "XaHNzq_menuOpen",
			"meta": "XaHNzq_meta",
			"projectRow": "XaHNzq_projectRow",
			"projectText": "XaHNzq_projectText",
			"renameInput": "XaHNzq_renameInput",
			"row-in": "XaHNzq_row-in",
			"rowActions": "XaHNzq_rowActions",
			"searchResultHeading": "XaHNzq_searchResultHeading",
			"searchResultMeta": "XaHNzq_searchResultMeta",
			"searchResultRow": "XaHNzq_searchResultRow",
			"searchResultSnippet": "XaHNzq_searchResultSnippet",
			"searchResultTitle": "XaHNzq_searchResultTitle",
			"searchResultWorkspace": "XaHNzq_searchResultWorkspace",
			"selected": "XaHNzq_selected",
			"sessionRow": "XaHNzq_sessionRow",
			"slot": "XaHNzq_slot",
			"time": "XaHNzq_time",
			"title": "XaHNzq_title",
			"visuallyHidden": "XaHNzq_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\雍远\deepseek-harness\packages\client\ui-workspace\src\client\WorkspacePicker.module.css.mjs
		const css$1 = ".YULJOq_modalAction{min-width:72px}.YULJOq_modalError,.YULJOq_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.YULJOq_modalError{color:var(--dsw-alias-state-error-primary)}.YULJOq_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "YULJOq_menuStatus",
			"modalAction": "YULJOq_modalAction",
			"modalError": "YULJOq_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\雍远\deepseek-harness\packages\client\ui-workspace\src\client\WorkspaceBrowser.module.css.mjs
		const css = ".yE8MXq_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.yE8MXq_root.yE8MXq_rail{padding-right:0}.yE8MXq_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.yE8MXq_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.yE8MXq_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.yE8MXq_root:not(.yE8MXq_rail) .yE8MXq_sectionHeader{margin-top:2px;margin-right:-4px}.yE8MXq_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.yE8MXq_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.yE8MXq_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.yE8MXq_searchSlotExpanded{max-width:100%;padding-left:0}.yE8MXq_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.yE8MXq_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.yE8MXq_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.yE8MXq_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.yE8MXq_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.yE8MXq_searchExpanded .yE8MXq_searchButton{width:28px;height:30px}.yE8MXq_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.yE8MXq_searchExpanded .yE8MXq_searchButton:hover{background:0 0}.yE8MXq_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.yE8MXq_searchExpanded .yE8MXq_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.yE8MXq_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.yE8MXq_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.yE8MXq_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.yE8MXq_rail .yE8MXq_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.yE8MXq_rail .yE8MXq_headerActions{max-width:none}.yE8MXq_rail .yE8MXq_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.yE8MXq_rail .yE8MXq_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.yE8MXq_rail .yE8MXq_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.yE8MXq_rail .yE8MXq_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.yE8MXq_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.yE8MXq_rail .yE8MXq_listArea{margin-left:0;margin-right:0;padding-left:0}.yE8MXq_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.yE8MXq_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.yE8MXq_wide{animation:yE8MXq_wide-in .2s var(--ds-ease-in-out)}@keyframes yE8MXq_wide-in{0%{opacity:0}}.yE8MXq_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.yE8MXq_flatList>*+*,.yE8MXq_searchTree>[role=treeitem]+[role=treeitem],.yE8MXq_groupSection>*+*{margin-top:2px}.yE8MXq_searchStatus,.yE8MXq_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.yE8MXq_searchWarning{color:var(--dsw-alias-label-secondary)}.yE8MXq_groupSection{position:relative}.yE8MXq_groupSection+.yE8MXq_groupSection{margin-top:4px}.yE8MXq_listTopDropIndicator,.yE8MXq_workspaceDropBefore:before,.yE8MXq_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.yE8MXq_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.yE8MXq_listTopDropActive>.yE8MXq_workspaceDropBefore:first-child:before{display:none}.yE8MXq_workspaceDropBefore:before{top:-8px}.yE8MXq_workspaceDropAfter:after{bottom:-8px}.yE8MXq_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.yE8MXq_groupSection>.yE8MXq_sessionOverflowButton{margin-top:0}.yE8MXq_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.yE8MXq_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.yE8MXq_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.yE8MXq_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.yE8MXq_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.yE8MXq_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.yE8MXq_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.yE8MXq_wide{animation:none}.yE8MXq_search,.yE8MXq_sectionLabel,.yE8MXq_searchSlot,.yE8MXq_searchInput,.yE8MXq_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "yE8MXq_clearButton",
			"deleteAction": "yE8MXq_deleteAction",
			"deleteStatus": "yE8MXq_deleteStatus",
			"empty": "yE8MXq_empty",
			"fade": "yE8MXq_fade",
			"flatList": "yE8MXq_flatList",
			"groupSection": "yE8MXq_groupSection",
			"headerActions": "yE8MXq_headerActions",
			"headerActionsHidden": "yE8MXq_headerActionsHidden",
			"iconButton": "yE8MXq_iconButton",
			"list": "yE8MXq_list",
			"listArea": "yE8MXq_listArea",
			"listTopDropActive": "yE8MXq_listTopDropActive",
			"listTopDropIndicator": "yE8MXq_listTopDropIndicator",
			"rail": "yE8MXq_rail",
			"renameError": "yE8MXq_renameError",
			"renameInput": "yE8MXq_renameInput",
			"root": "yE8MXq_root",
			"search": "yE8MXq_search",
			"searchButton": "yE8MXq_searchButton",
			"searchExpanded": "yE8MXq_searchExpanded",
			"searchInput": "yE8MXq_searchInput",
			"searchSlot": "yE8MXq_searchSlot",
			"searchSlotExpanded": "yE8MXq_searchSlotExpanded",
			"searchStatus": "yE8MXq_searchStatus",
			"searchTree": "yE8MXq_searchTree",
			"searchWarning": "yE8MXq_searchWarning",
			"sectionHeader": "yE8MXq_sectionHeader",
			"sectionLabel": "yE8MXq_sectionLabel",
			"sectionLabelHidden": "yE8MXq_sectionLabelHidden",
			"sessionOverflowButton": "yE8MXq_sessionOverflowButton",
			"treeBody": "yE8MXq_treeBody",
			"wide": "yE8MXq_wide",
			"wide-in": "yE8MXq_wide-in",
			"workspaceDropAfter": "yE8MXq_workspaceDropAfter",
			"workspaceDropBefore": "yE8MXq_workspaceDropBefore"
		};
		//#endregion
		...
		*/
		...
		/**
		* Pinned bottom "Recycle bin" section: archived sessions (hidden from the
		* ordinary groupings) with a restore action. Default collapsed; the header
		* shows the current count. Restoring removes the id from the archive set,
		* which makes the session visible again in its original group.
		* @param props - archived ids, the sessions list, restore callback, time base, locale.
		* @returns the section element tree.
		*/
		function RecycleSection({ archivedSessionIds, sessions, onRestore, now, t }) {
			const [expanded, setExpanded] = (0, react.useState)(false);
			const rows = (0, react.useMemo)(() => archivedSessionIds.map((id) => sessions.byId[id]).filter((s) => s !== void 0 && !s.blank), [archivedSessionIds, sessions]);
			const headerStyle = { boxSizing: "border-box", width: "100%", height: 30, display: "flex", alignItems: "center", gap: 6, padding: "0 8px", border: "none", borderRadius: 8, background: "transparent", color: "var(--dsw-alias-label-secondary)", cursor: "pointer", fontSize: 13, lineHeight: "18px", flex: "none" };
			const titleStyle = { flex: "1", textAlign: "left", minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" };
			const countStyle = { color: "var(--dsw-alias-label-tertiary)", fontSize: 12, lineHeight: "17px" };
			const listStyle = { listStyle: "none", margin: 0, padding: "0 8px 4px" };
			const rowStyle = { display: "flex", alignItems: "center", gap: 6, height: 30, borderRadius: 8, padding: "0 4px 0 8px" };
			const rowTitleStyle = { flex: "1", minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: 13, lineHeight: "18px", color: "var(--dsw-alias-label-primary)" };
			const rowTimeStyle = { flex: "none", color: "var(--dsw-alias-label-tertiary)", fontSize: 12, lineHeight: "17px" };
			const restoreStyle = { flex: "none", border: "none", background: "transparent", color: "var(--dsw-alias-label-secondary)", cursor: "pointer", fontSize: 12, lineHeight: "17px", padding: "2px 6px", borderRadius: 6 };
			const emptyStyle = { padding: "0 12px 6px", color: "var(--dsw-alias-label-tertiary)", fontSize: 12, lineHeight: "17px" };
			return (0, react_jsx_runtime.jsxs)("div", { style: { flex: "none" }, children: [
				(0, react_jsx_runtime.jsx)("button", { type: "button", style: headerStyle, "aria-expanded": expanded, onClick: () => setExpanded((v) => !v), children: [
					(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconTrashOutline16, { size: 14 }),
					(0, react_jsx_runtime.jsx)("span", { style: titleStyle, children: t("recycle.title") }),
					(0, react_jsx_runtime.jsx)("span", { style: countStyle, children: String(rows.length) })
				] }),
				expanded && rows.length === 0 && (0, react_jsx_runtime.jsx)("div", { style: emptyStyle, children: t("recycle.empty") }),
				expanded && rows.length > 0 && (0, react_jsx_runtime.jsx)("ul", { style: listStyle, children: rows.map((s) => {
					const node = sessionNode(s, /* @__PURE__ */ new Map());
					return (0, react_jsx_runtime.jsxs)("li", { style: rowStyle, children: [
						(0, react_jsx_runtime.jsx)("span", { style: rowTitleStyle, title: node.title, children: node.title }),
						(0, react_jsx_runtime.jsx)("span", { style: rowTimeStyle, children: timeLabel(node.updatedAt, now, t) }),
						(0, react_jsx_runtime.jsx)("button", { type: "button", style: restoreStyle, "aria-label": t("recycle.actions.aria", { name: node.title }), onClick: () => onRestore(node.id), children: t("recycle.restore") })
					] }, node.id);
				}) })
			] });
		}
		...
		function SessionTree({ useSessions, startSession, open, forkSession, workspaces, archivedSessionIds, onRenameRequest, onDeleteRequest, onSessionRename, onSessionArchive, onRestore, insertWorkspaceBefore, insertSessionBefore, orderBy, groupExpansion, setGroupExpanded, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, home, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)(RecycleSection, { archivedSessionIds, sessions: list, now, onRestore, t }),
					(0, react_jsx_runtime.jsx)("span", { className: WorkspaceBrowser_module_css_default.fade })
				]
			});
		}
		/** The flat "In one list" body: every session is one draggable top-level row. */
		function FlatList({ useSessions, open, forkSession, onSessionRename, onSessionArchive, onRestore, archivedSessionIds, orderBy, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, t }) {
			const list = useSessions((s) => s);
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				}), (0, react_jsx_runtime.jsx)(RecycleSection, { archivedSessionIds, sessions: list, now, onRestore, t }), (0, react_jsx_runtime.jsx)("span", { className: WorkspaceBrowser_module_css_default.fade })]
			});
		}
		...
		*/
		function WorkspaceBrowser({ wide, expandSidebar, useSessions, useWorkspaces, useStore, actions, startSession, open, renameSession, forkSession, renameWorkspace, deleteWorkspace, insertWorkspaceBefore, archiveSession, restoreSession, insertSessionBefore, createWorkspace, searchSessions, searchResultLimit, useDirectoryFlow, useHostDescription, renderSlot, t }) {
		...
		*/
		...
		const zh = {
			...
			"menu.fork": "分叉会话",
			"menu.archiveSession": "移入档案柜",
			"recycle.title": "档案柜",
			"recycle.restore": "恢复",
			"recycle.empty": "档案柜为空",
			"recycle.actions.aria": "恢复会话“{name}”",
		...
		const en = {
			...
			"menu.archiveSession": "Move to file cabinet",
			"recycle.title": "File cabinet",
			"recycle.restore": "Restore",
			"recycle.empty": "File cabinet is empty",
			"recycle.actions.aria": "Restore session {name}",
		...
		function apply(ctx) {
			...
			const browserInjected = () => ({
				...
				restoreSession: async (sessionId) => {
					await ctx.workspaces.restoreSession(sessionId);
				},

...
const workspaceRestoreSessionRequestSchema = z$1.object({ sessionId: sessionIdSchema });
/** workspace.restoreSession response value: the full updated archive set. */
const workspaceRestoreSessionValueSchema = z$1.object({ archivedSessionIds: z$1.array(sessionIdSchema) });
//#endregion
...
const UNARY_ROUTES = {
	...
	"workspace.restoreSession": {
		schema: workspaceRestoreSessionRequestSchema,
		invoke: (api, r) => api.workspace.restoreSession(r)
	},
	"skill.list": {
